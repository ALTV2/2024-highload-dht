...
import ru.vk.itmo.test.reference.HandleResult;
import ru.vk.itmo.test.reference.MergeHandleResult;
...
//        }
    ...
    public synchronized void stop() {
        super.stop();
        ru.vk.itmo.test.reference.ReferenceService.shutdownAndAwaitTermination(executorLocal);
